...
describe('list-add-item', () => {
  test('should append items', () => {
    const result =
      shell.exec(`set -e; source dist/data/lists.func.sh; LIST=''; list-add-item LIST a; echo "1: $LIST"; list-add-item LIST b; echo -n "2: $LIST"`, execOpts)
  ...
  test('should handle spaces within items', () => {
    const result =
      shell.exec(`set -e; source dist/data/lists.func.sh; LIST=''; list-add-item LIST 'a b'; echo -e "$LIST"; list-add-item LIST 'c d'; echo -en "$LIST"`, execOpts)
  ...
  test('should be unchanged if the add var is empty (empty list)', () => {
    const result =
      shell.exec(`set -e; source dist/data/lists.func.sh; LIST=''; list-add-item LIST "$NEW_ITEM"; echo -e "$LIST"`, execOpts)
  ...
  test(`should build a string usable by 'for'`, () => {
    const result =
      shell.exec(`set -e; source dist/data/lists.func.sh; list-add-item LIST foo; list-add-item LIST bar; for i in $LIST; do echo $i; done`, execOpts)
...
describe('list-add-uniq', () => {
  test('should add a new item', () => {
    const result =
      shell.exec(`set -e; source dist/data/lists.func.sh; LIST=foo$'\n'bar; list-add-uniq LIST baz; echo "$LIST"`, execOpts)
    const expectedOut = expect.stringMatching(/^foo\nbar\nbaz\n$/)
    assertMatchNoError(result, expectedOut)
  })
...
describe('list-count', () => {
  ...
  const result = shell.exec(`set -e; source dist/data/lists.func.sh; LIST="${list}"; list-count LIST`, execOpts)
...
describe('list-from-csv', () =>{
  test('should create a good list from empty csv', () => {
    const result =
      shell.exec(`set -e; source dist/data/lists.func.sh; list-from-csv LIST ''; echo "$LIST"`, execOpts)
    const expectedOut = expect.stringMatching(/^\n$/)
    assertMatchNoError(result, expectedOut)
  })
  ...
  test('should create a good list from one item', () => {
    const result =
      shell.exec(`set -e; source dist/data/lists.func.sh; list-from-csv LIST foo; echo "$LIST"`, execOpts)
    const expectedOut = expect.stringMatching(/^foo\n$/)
    assertMatchNoError(result, expectedOut)
  })
  ...
  test('should create a good list from multiple items (no spaces)', () => {
    const result =
      shell.exec(`set -e; source dist/data/lists.func.sh; list-from-csv LIST foo,bar; echo "$LIST"`, execOpts)
    const expectedOut = expect.stringMatching(/^foo\nbar\n$/)
    assertMatchNoError(result, expectedOut)
  })
  ...
  test('should handle in-place replace', () => {
    const result =
      shell.exec(`set -e; source dist/data/lists.func.sh; LIST="foo,bar"; list-from-csv LIST; echo "$LIST"`, execOpts)
    const expectedOut = expect.stringMatching(/^foo\nbar\n$/)
    assertMatchNoError(result, expectedOut)
  })
})
...
describe('list-get-index', () => {
  test('should echo index of item if present', () => {
    const result =
      shell.exec(`set -e; source dist/data/lists.func.sh; LIST=hey$'\n'there; list-get-index LIST there`, execOpts)
...
describe('list-get-item', () => {
  ...
  test('list-get-item should handle spaces in items', () => {
    const result =
      shell.exec(`set -e; source dist/data/lists.func.sh; LIST=billy$'\n''hey there'; list-get-item LIST 1 '\n'`, execOpts)
...
describe('list-get-item-by-prefix', () => {
  test('matches first of multiple matches', () => {
    const result =
      shell.exec(`set -e; source dist/data/lists.func.sh; LIST="hey there"$'\n'"hey you"; list-get-item-by-prefix LIST "hey "`, execOpts)
    const expectedOut = expect.stringMatching(/^hey there$/)
    assertMatchNoError(result, expectedOut)
  })
  ...
  test('matches interior item', () => {
    const result =
      shell.exec(`set -e; source dist/data/lists.func.sh; LIST="look there"$'\n'"hey you"; list-get-item-by-prefix LIST "hey "`, execOpts)
...
describe('list-join', () => {
  ...
  const result = shell.exec(`set -e; source dist/data/lists.func.sh; LIST="${list}"; list-join LIST '${joiner}'`, execOpts)
  const expectedOut = expect.stringMatching(new RegExp(`^${output}$`))
  assertMatchNoError(result, expectedOut)
})
})
...
describe('list-rm-item', () => {
  ...
  test('properly final item in a list', () => {
    const result =
      shell.exec(`set -e; source dist/data/lists.func.sh; LIST=hey; list-rm-item LIST 'hey'; echo "$LIST"`, execOpts)
    const expectedOut = expect.stringMatching(/^\n$/)
    assertMatchNoError(result, expectedOut)
  })
  ...
  test('deals with spaces in items', () => {
    const result =
      shell.exec(`set -e; source dist/data/lists.func.sh; LIST='hey there'; list-rm-item LIST 'hey there'; echo "$LIST"`, execOpts)
    const expectedOut = expect.stringMatching(/^\n$/)
    assertMatchNoError(result, expectedOut)
  })
