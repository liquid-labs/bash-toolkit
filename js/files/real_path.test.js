...
test.only('real_path should not change the working directory', () => {
  ...
  const pwdReal = shell.exec(`source bash/files/real_path.func.sh && real_path "${result.stdout}"`, execOpts).stdout
